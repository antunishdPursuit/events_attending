      ...
      <div className="row align-items-center">
        ...
        <div className="col-md-9">
          ...
          {typeof event.priceRanges === "undefined" ? (
            <Link to={event.url} className="fs-6">Check Price</Link>
          ) : (
            <div className="d-flex align-items-center">
              <Link to={event.url} className="fs-6 me-3">Tickets from ${event.priceRanges[0].min} to ${event.priceRanges[0].max}</Link>
              {!isEventAdded ? (
